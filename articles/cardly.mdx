---
title: 'Cardly'
description: 'Conceptualized collaborative web app in which users work mainly on a board that contains multiple vertical lists in which they add, delete, modify & move around cards that represent some work to be done or some other information crucial for the user'
