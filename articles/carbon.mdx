...
- Backend
  ...
  - [https://redis.io](Redis) Docker container as job queue handling minting of new tokens and handles token transfers
  - [Web3 v1](https://github.com/ChainSafe/web3.js) for chain access
