  ...
  const Nav = () => (
    <div className="flex justify-center">
      <Link href="/">
        ...
        >
          <span className="relative text-yellow-400 font-extrabold text-3xl tracking-wide leading-8 pl-4 pr-3.5">
            Miguel Franken
          </span>
        </a>
      </Link>
  ...
  const Hero = () => (
    <div className="mt-16 sm:mt-24">
      <div className="text-center">
        <h1 className="text-4xl tracking-tight font-bold text-amber-600 sm:text-5xl sm:tracking-tight md:text-6xl md:tracking-tight">
          {title}
        </h1>
